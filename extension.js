...
class Extension {
	...
	enable() {
		...
		this._main_session_mode_updated = Main.sessionMode.connect('updated', this._dock_refresh.bind(this));
    ...
    disable() {
		...
		if (this._main_session_mode_updated) {Main.sessionMode.disconnect(this._main_session_mode_updated);}
